...
# Generate the synthetic trajectories.  Need to run 'make sim'.

# Tensors generated uniformly at random
dir=processed_data/synthetic_experiments/uniform
mkdir -p $dir
for i in {1..20}; do ./sim --sim_rand -d 4 -n 100 -s 200 -o $dir/seqs-4-100-200.$i.txt -t $dir/P-4-100-200.$i.txt; done
...
mkdir -p $dir
./sim --sim_R1 -n 100 -s 200 -o $dir/seqs-R1-100-200.txt -t $dir/R1.txt
...
mkdir -p $dir
./sim --sim_R2 -n 100 -s 200 -o $dir/seqs-R2-100-200.txt -t $dir/R2.txt
